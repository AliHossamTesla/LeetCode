...
void doYourJop()
{
    ...
    if(ma[n] < min(ma[1],ma[2]))
        cout << ma[n] + 1 << sp << min(ma[1], ma[2]) + 1 << el;
    else if(ma[n] > max(ma[1],ma[2]))
        cout << ma[n] + 1 << sp << max(ma[1], ma[2]) + 1 << el;
    else
        cout << ma[1] + 1 << sp << ma[2] + 1 << el;
}
int main()
{
    Ali_Hossam
